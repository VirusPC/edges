...
- `docs/adr/0008-edges-task-project-grouping.md`：directory-first 的 Multica-like Project + frontmatter 双写；修订 ADR 0002 的路径（嵌在 project-slug 下）。本轮只定文档，不迁看板、不改 CLI；实现轮必须先让 CLI 跟上。
