...
- **SUT 是上游 LoCoMo harness**（如 snap-research/locomo 的官方评测入口），不是把项目记忆接到 LoCoMo 当记忆后端。
...
- [`knowledge/tasks/_default/in_progress/2026-09-16--LoCoMo评测流水线冒烟.md`](../../knowledge/tasks/_default/in_progress/2026-09-16--LoCoMo评测流水线冒烟.md) 只负责把上游链路跑通并留下评测报告。
