...
**Why:** 目录约定 README 已是真理源，区块外也指过去了。交互口吻是通用偏好，不是本仓事故闸门。放进 `.memory` 会让改脚本还多一跳，该看的时候反而可能打不开。

**How to apply:** 改根硬约束时不要把 README 里的目录细则或说话风格搬回来。skill 用法仍在 ask / remember 正文。
