...
description: 改 /tasks/ 持久入口、list --group-by、或看板站 vs Artifacts 时打开：不新开 status station；复用同一审阅壳。不窄于 md 时为三栏且不写回 git。窄屏布局见 ADR 0023。决策见 docs/adr/0021、0022 与 0023。
metadata:
