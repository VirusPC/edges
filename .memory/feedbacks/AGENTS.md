...
- [根 changelog 不要堆 schema 字段表](feedback_changelog_no_schema_dump.md) — 写根 CHANGELOG Unreleased 时打开：用人话完整句写能做什么，对照 [1.2.0]；不要把 schema 字段表或 flag 汤塞进一段。缘起 https://github.com/VirusPC/edges/pull/110。
