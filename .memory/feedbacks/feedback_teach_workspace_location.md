...
metadata:
  ...
  edges-updated-at: "2026-09-11T10:34:13+00:00"
---

teach 技能的教学工作区放 knowledge/teach/<topic>/，作为知识资产随仓库提交；不要再放 .teaching/。
**Why:** 2026-09-10 用户在教学第一课把工作区建到 .teaching/ 后明确纠正：教学工作区归 knowledge/ 树。2026-09-11 已将 `.teaching/obsidian-cli` 迁到 `knowledge/teach/obsidian-cli/`；根下 `.teaching/` 不再代表现行约定。
