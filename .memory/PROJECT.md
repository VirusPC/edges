...
- [classifyTasks 软聚类；Task Project 元数据只做索引层](projects/project_classify_tasks_and_task_project_metadata.md) — 改 Task Project 元数据、classifyTasks / project-tasks-classify 工作流或看板 AGENTS.md 时：只做索引/描述层（Q18=A），不把 Task 升成 Memory Type。Skill 路径 extensions/skills/project-tasks-classify/。决策见 docs/adr/0010-classify-tasks-and-task-project-metadata.md。
