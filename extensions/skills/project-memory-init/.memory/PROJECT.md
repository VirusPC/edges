...
- [项目记忆的类型集合](projects/project_type_set.md) — 官方 init 种子仍是六类；类型集合由 LAYOUT+本层登记决定，不是 PROTOCOL 闭集。可扩展见仓库根 docs/adr/0006-extensible-project-memory-types.md。否掉把 docs 等示例写进默认种子。user 进仓且 gitignore；v1 不做晋升。
