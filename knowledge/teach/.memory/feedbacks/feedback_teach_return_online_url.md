...
metadata:
  ...
  edges-updated-at: "2026-09-11T10:11:39+00:00"
---
...
**How to apply:** 把 `knowledge/teach/<topic>/lessons/<file>.html`（或 `reference/` 下的 HTML）映射到公网站点同一相对路径，把完整 http(s) URL 写进当轮回复。没有课页产出时说明为什么没有在线 URL。禁止只报本地路径或内网主机名。
