# git-automation-for-ingest

## Purpose
This capability handles the automated Git workflow for the ingest process, including validation, file creation, branching, committing, and pushing.
